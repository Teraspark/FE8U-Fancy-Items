...
set "target_rom=%~dp0FE8_ItemTest.gba"
...
REM if /I not [%1]==[quick] (

  REM @rem only do the following if this isn't a make hack quick

  REM echo:
  REM echo Generating patch

  REM cd "%base_dir%"
  REM "%ups%" diff -b "%source_rom%" -m "%target_rom%" -o "%target_ups%"
